...
<body>
    ...
    <div style="text-align: center; margin: 40px 0; padding: 20px; background-color: #fff; border-radius: 15px; width: 80%; margin-left: auto; margin-right: auto; box-shadow: 0 2px 5px rgba(0,0,0,0.1);">
        <h2 style="color: #a72023ff; margin-bottom: 20px;">APA PENDAPAT ANDA?</h2>
        <p style="font-size: 16px; margin-bottom: 25px; color: #666;">Bagikan pengalaman Anda di Park Shanghai!</p>
        <a href="review_db.php" style="display: inline-block; padding: 15px 40px; background-color: #a72023ff; color: white; text-decoration: none; border-radius: 10px; font-weight: 600; margin-right: 15px;">+ Tulis Review</a>
        <a href="view_reviews_db.php" style="display: inline-block; padding: 15px 40px; background-color: #f1f1dcff; color: #a72023ff; text-decoration: none; border-radius: 10px; font-weight: 600; border: 2px solid #bdbba7ff;">Lihat Semua Review</a>
    </div>

    <div style="width: 100%; padding: 40px 0; background-color: #dadabeff;">
    ...
    <form action="submit_db.php" method="post" style="align-self: center; justify-self: center; font-family: 'Lato', sans-serif; font-weight: 800; width: 70%;">
