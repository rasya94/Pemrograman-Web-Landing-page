...
<body>
    ...
    <form action="submit_review_db.php" method="post" enctype="multipart/form-data" style="align-self: center; justify-self: center; font-family: 'Lato', sans-serif; font-weight: 800; width: 70%; margin-bottom: 50px;">
